...
export const SERVICES = [
  ...
  {
    id: 'crypto-web3', icon: '🔗', title: 'Crypto & Web3 Development',
    short: 'DeFi platforms, NFT marketplaces, dApps, and smart contracts on any chain', col: '#F7931A',
    hero: 'Build the decentralised future -- from DeFi protocols and NFT platforms to DAO governance and Layer-2 solutions. Fully audited smart contracts, multi-chain support, and enterprise-grade security.',
    feats: [
      'Smart contract development (Solidity/Rust)',
      'DeFi protocol design & deployment',
      'NFT marketplace (mint, list, trade, royalties)',
      'Token creation (ERC-20, BEP-20, SPL)',
      ...
      'Gas optimisation & audit-ready code',
      'IPFS & decentralised storage integration',
    ],
    tech: ['Solidity','Rust','Hardhat','Foundry','Ethers.js','Web3.js','IPFS','Chainlink','OpenZeppelin','Wagmi','Viem','The Graph'],
    proc: ['Architecture','Tokenomics','Smart Contract','Frontend dApp','Audit','Deploy'],
    stats: [{n:'15+',l:'Chains Supported'},{n:'100%',l:'Audit-Ready'},{n:'$0',l:'Gas Waste'},{n:'Multi',l:'Chain'}],
  },
  {
    id: 'tokenization', icon: '🪙', title: 'Tokenization & RWA',
    short: 'Real-world asset tokenization, white-label wallets, and token launch infrastructure', col: '#9945FF',
    hero: 'Tokenize anything -- real estate, equity, commodities, art, or IP rights. We build the full infrastructure: smart contracts, compliance layer, investor dashboard, and white-label wallet.',
    feats: [
      'Real-world asset (RWA) tokenization',
      'Security token (STO) infrastructure',
      'White-label crypto wallet (iOS + Android + Web)',
      'KYC/AML compliance integration',
      'Token vesting & cliff schedules',
      'Investor portal & cap table management',
      'Fractional ownership smart contracts',
      'Multi-sig treasury management',
      'Launchpad & IDO platform',
      'Token airdrop & distribution engine',
      'Liquidity pool setup (Uniswap/PancakeSwap)',
      'Legal-ready token documentation support',
    ],
    tech: ['Solidity','ERC-1400','ERC-3643','Polygon','Ethereum','Solana','Fireblocks SDK','Onfido KYC','React Native','Node.js','PostgreSQL','AWS'],
    proc: ['Compliance Review','Token Design','Smart Contract','Wallet Build','Launchpad','TGE Support'],
    stats: [{n:'ERC-1400',l:'Security Token'},{n:'Multi-Sig',l:'Treasury'},{n:'KYC',l:'Compliant'},{n:'White',l:'Label Ready'}],
  },
  {
    id: 'crypto-wallet', icon: '👛', title: 'White-Label Crypto Wallet',
    short: 'Fully branded multi-chain wallets for iOS, Android and Web', col: '#14F195',
    hero: 'Launch your own branded crypto wallet in weeks, not months. Multi-chain support, biometric security, DeFi integrations, and full white-labelling -- your brand, your users, your revenue.',
    feats: [
      'Multi-chain support (ETH, BNB, SOL, MATIC, BTC)',
      'White-label iOS + Android + Web app',
      'HD wallet with BIP39/BIP44 key generation',
      'Biometric & PIN authentication',
      'In-app token swap (DEX aggregator)',
      'NFT gallery & collectibles view',
      'Buy crypto via fiat (MoonPay/Ramp integration)',
    ...
    tech: ['React Native','Swift','Kotlin','Web3.js','Ethers.js','MoonPay','WalletConnect','Ledger SDK','Firebase','Node.js','PostgreSQL','AWS'],
    proc: ['Brand Design','Architecture','Chain Integration','Security Audit','Store Launch','Support'],
    stats: [{n:'10+',l:'Chains'},{n:'iOS+Android',l:'+Web'},{n:'Biometric',l:'Auth'},{n:'White',l:'Label'}],
  },
];
