// Cyberpunk service config (rank, color, glow)
export const CR_CHARACTERS = {
  'web-info':  { name: 'Wizard',       rarity: 'epic',      elixir: 5,  tagline: 'Full-Stack Web Architect',   col:'#00C9FF', glowCol:'rgba(0,201,255, 0.7)' },
  'ecommerce': { name: 'Goblin',       rarity: 'common',    elixir: 2,  tagline: 'Commerce Platform Engineer',        col:'#4FFFB0', glowCol:'rgba(79,255,176, 0.7)' },
  'android':   { name: 'Barbarian',    rarity: 'common',    elixir: 3,  tagline: 'Native Android Specialist',     col:'#3FC380', glowCol:'rgba(63,195,128, 0.7)' },
  'ios':       { name: 'Archer Queen', rarity: 'legendary', elixir: 0,  tagline: 'Swift iOS Craftsman',  col:'#FC5C7D', glowCol:'rgba(252,92,125, 0.7)' },
  'hybrid':    { name: 'Grand Warden', rarity: 'legendary', elixir: 0,  tagline: 'Cross-Platform Architect',     col:'#7c3aed', glowCol:'rgba(124,58,237, 0.7)' },
  'digital':   { name: 'Bowler',       rarity: 'epic',      elixir: 5,  tagline: 'Growth & SEO Strategist',  col:'#F7971E', glowCol:'rgba(247,151,30, 0.7)' },
  'payment':   { name: 'Bomber',       rarity: 'common',    elixir: 2,  tagline: 'Payment Systems Engineer', col:'#FF9F43', glowCol:'rgba(255,159,67, 0.7)'  },
  'blog':      { name: 'Goblin King',  rarity: 'rare',      elixir: 3,  tagline: 'Content Platform Builder',   col:'#FFD700', glowCol:'rgba(255,215,0, 0.7)'   },
};
